...
*A quick fix might be to set .id on the request to an integer value based on the uptime of the MCU (time.ticks_us()
for example) and check .id on the response matches.*
