...
- **Current general-availability version of the micropython esp8266 port ucollections module does not define an OrderedDict class.**
...
The module has provided reasonable defaults that match this simple case; 
