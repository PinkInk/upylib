...
p.varbinds["1.3.6.1.2.1.2.2.1.1.1"]=usnmp2.ASN1_INT,23
...
p.varbinds["1.3.6.1.2.1.2.2.1.11.1"] = (usnmp2.ASN1_INT, 23232)
p.varbinds["1.3.6.1.2.1.2.2.1.11.1"]

bytes(p)
p1 = usnmp2.SnmpPacket(bytes(p))
p1.community
p1.req_id
